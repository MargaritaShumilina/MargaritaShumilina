...
[Ссылка на GitLab](https://gitlab.com/margarita.belockopytova)

## ⚡ Мой стек:

<strong>Hard skills</strong>: HTML, CSS, JavaScript, React, TypeScript, Redux, SASS, Atlassian Jira, GraphQL, Docker, Tailwind CSS, StoryBook, Express.js, FSD, Figma, GIT, MongoDB, NodeJS 
...
1. [Приложение с авторизацией и выводом дерева объектов](https://github.com/MargaritaShumilina/one-page-application) - приложение состоит из формы авторизации и компонента дерева объектов, с которым можно взаимодействовать. Стек: React, JS, TypeScript, graphQL.
2. [Калькулятор](https://github.com/MargaritaShumilina/test-calculator) - создание калькулятора с использованием библиотеки mathjs (React). [Релиз](https://test-calculator-mu.vercel.app/)
3. [Чат с AI](https://github.com/MargaritaShumilina/test-chat) - реализация небольшого чата с AI Gemini Pro (React). [Релиз](https://test-chat-pi.vercel.app/)
4. [TODO](https://github.com/MargaritaShumilina/test-todo) - приложения для создания списка дел с сортировкой по статусу задачи, дате и заголовку (React). [Релиз](https://test-todo-seven.vercel.app/)
5. [Таблица со странами](https://github.com/MargaritaShumilina/test-countries) - Создание таблицы из стран, которые подтягиваются по API, по нажатию открывается pop-up с более полной информацией по стране. [Релиз](https://test-countries-ten.vercel.app/)
